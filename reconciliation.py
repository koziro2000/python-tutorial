...
SCD_Data = pd.read_csv('PIRE_149_Daily_Cash_Reconciliation.csv')
Ticketing_Data = pd.read_csv('PIRE-149_PI_Ticketing_Tickets.csv', encoding = "ISO-8859-1")
...
worksheet.conditional_format('U2:U380', {'type': '2_color_scale'})
writer.save()
